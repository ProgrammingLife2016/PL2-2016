...
public interface SequenceGraph extends Iterable<GraphNode> {
   ...
   * @param updateInlinks If true, the outedges of the nodes which have an inlink into this node
   *     will be updated.
   * @parem updateOutlinks If true, the inedges of the nodes which have outedge out of this node
   *     will be updated.    
   * @return The element that was removed, or <code>null</code> if no such element was found
   */
  GraphNode remove(int identifier, boolean updateInlinks, boolean updatOutlinks);
