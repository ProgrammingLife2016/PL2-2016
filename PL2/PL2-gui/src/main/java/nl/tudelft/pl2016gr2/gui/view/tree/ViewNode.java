...
public class ViewNode extends Circle {
	...
	/**
	 * Draw an elipsis after a parent node to indicate that the parent has
	 * children, but there is not enough space to draw the children.
	 *
	...
	/**
	 * Animate the zoom out of 1 level (to the direct parent of the current
	 * root).
	 *
	 * @param timeline the timeline which is used for the animation.
	 */
	 ...
	 *
	 * @param originalArea the area of the currently drawn tree.
	 * @param zoomArea the area of the tree where the current tree will be drawn
	 * after zooming out.
	 * @param timeline the timeline which is used for the animation.
	 */
