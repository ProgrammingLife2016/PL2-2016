...
public class TreeController {
	...
	/**
	 * Initialize the event handlers which zoom in when a node is clicked or
	...
	/**
	 * Initialize the listeners which resize the content of the graph area when
	 * the pane or the window is resized.
	 */
