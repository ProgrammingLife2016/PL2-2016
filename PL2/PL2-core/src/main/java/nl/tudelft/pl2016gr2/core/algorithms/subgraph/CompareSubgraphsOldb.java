...
//
/// **
// * This class is used to compare and align two subgraphs with each other, so all of the
// overlapping
...
// */
// public static void removeEmptyLevels(ArrayList<NodePosition> graphOrder) {
// boolean[] levelIsNotEmpty = new boolean[graphOrder.get(graphOrder.size() - 1).getLevel() + 1];
// for (NodePosition nodePosition : graphOrder) {
